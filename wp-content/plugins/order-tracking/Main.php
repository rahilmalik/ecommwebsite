<?php
/*
Plugin Name: Status and Order Tracking
...
function EWD_OTP_Jquery_Ui_Enqueue() {
	wp_enqueue_script( 'jquery-ui-core', array( 'jquery' ) );
	wp_enqueue_script( 'jquery-ui-datepicker', array( 'jquery' ) );
	wp_enqueue_style( 'ewd-uasp-jquery-datepicker-css', plugins_url("order-tracking/css/jquery-ui.min.css") );
}
add_action( 'wp_enqueue_scripts', 'EWD_OTP_Jquery_Ui_Enqueue' );
//add_action( 'admin_enqueue_scripts', 'EWD_OTP_Jquery_Ui_Enqueue' );
...
function Add_EWD_OTP_FrontEnd_Scripts() {
	...
	if ($Retrieving_Results_Label == "") {$Retrieving_Results_Label = __('Retrieving results...', 'order-tracking');}
	$otp_js_labelling_data = array(
		'retrieving_results' => $Retrieving_Results_Label,
	);
	wp_localize_script( 'ewd-otp-js', 'otp_js_labelling', $otp_js_labelling_data );
}
