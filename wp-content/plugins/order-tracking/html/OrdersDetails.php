...
$Order = $wpdb->get_row( $wpdb->prepare( "SELECT * FROM $EWD_OTP_orders_table_name WHERE Order_ID='%d'", intval( $_GET['Order_ID'] ) ) );
				...
				<form id="addtag" method="post" action="admin.php?page=EWD-OTP-options&OTPAction=EWD_OTP_EditOrder&DisplayPage=Orders" class="validate" enctype="multipart/form-data">
					...
					<div class="ewd-otp-admin-edit-product-left">
						...
						<div class="form-field form-required">
							<input name="Order_Name" id="Order_Name" type="text" value="<?php echo stripslashes($Order->Order_Name); ?>" placeholder="<?php _e('Order Name', 'order-tracking') ?>" />
						</div>
							...
							<div class="ewd-otp-dashboard-new-widget-box-bottom">
								<table class="form-table">
									<tr>
										...
										<td>
											<input type='text' name="Order_Number" id="Order_Number" value="<?php echo stripslashes($Order->Order_Number); ?>" size="60" />
										</td>
									</tr>
									<tr>
										<th><label for="Order_Email"><?php _e("Order Email", 'order-tracking') ?></label></th>
										<td>
											<input type='text' name="Order_Email" id="Order_Email" value="<?php echo stripslashes($Order->Order_Email); ?>" size="60" />
						...
						<div class="ewd-otp-dashboard-new-widget-box ewd-widget-box-full ewd-otp-admin-closeable-widget-box ewd-otp-admin-edit-product-left-full-widget-box ewd-otp-admin-widget-box-start-closed" id="ewd-otp-admin-edit-order-status-history-widget-box">
							<div class="ewd-otp-dashboard-new-widget-box-top"><?php _e('Order Status History', 'order-tracking'); ?><span class="ewd-otp-admin-edit-product-down-caret">&nbsp;&nbsp;&#9660;</span><span class="ewd-otp-admin-edit-product-up-caret">&nbsp;&nbsp;&#9650;</span></div>
							<div class="ewd-otp-dashboard-new-widget-box-bottom">
					...
					<div class="ewd-otp-admin-edit-product-right">
						...
						<p class="submit ewd-otp-admin-edit-product-submit-p"><input type="submit" name="submit" id="submit" class="button-primary ewd-otp-admin-edit-product-save-button" value="<?php _e('Edit Order', 'order-tracking') ?>"  /></p>
						...
						<div class="ewd-otp-dashboard-new-widget-box ewd-widget-box-full ewd-otp-admin-closeable-widget-box" id="ewd-otp-admin-edit-order-custom-fields-widget-box">
							...
							<div class="ewd-otp-dashboard-new-widget-box-bottom">
								<table class="form-table">
									...
									$MetaValues = $wpdb->get_results( $wpdb->prepare( "SELECT Field_ID, Meta_Value FROM $EWD_OTP_fields_meta_table_name WHERE Order_ID=%d", intval( $_GET['Order_ID'] ) ) );
