...
<div id="heade-top">
  <div class="container">
    <div class="row">      
      <div class="col-lg-4 col-md-4 left-box">
          ...
          <?php $blog_info = get_bloginfo( 'name' ); ?>
            <?php if ( ! empty( $blog_info ) ) : ?>
              <?php if ( is_front_page() && is_home() ) : ?>
                <?php if( get_theme_mod('vw_bakery_logo_title_hide_show',true) != ''){ ?>
            ...
            ?>
            <?php if( get_theme_mod('vw_bakery_tagline_hide_show',true) != ''){ ?>
      ...
      <div class="col-lg-4 col-md-4 right-box">
