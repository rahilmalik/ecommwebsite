...
<footer role="contentinfo">
    ...
    <div id="footer-2">
      	<div class="copyright">
            <div class="container">
                <p><?php echo esc_html(get_theme_mod('vw_bakery_footer_text',__('Coffee Shop WordPress Theme By VWThemes','cafe-coffee-shop'))); ?></p>
                <?php if( get_theme_mod( 'vw_bakery_hide_show_scroll',true) != '') { ?>
