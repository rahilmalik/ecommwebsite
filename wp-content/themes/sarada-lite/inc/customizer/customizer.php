...
function sarada_lite_customize_preview_js() {
	wp_enqueue_script( 'sarada-customizer', get_template_directory_uri() . '/inc/js/customizer.js', array( 'customize-preview' ), SARADA_LITE_THEME_VERSION, true );
}
add_action( 'customize_preview_init', 'sarada_lite_customize_preview_js' );

function sarada_lite_customize_script(){
    
    wp_enqueue_style( 'sarada-customize', get_template_directory_uri() . '/inc/css/customize.css', array(), SARADA_LITE_THEME_VERSION );
    wp_enqueue_script( 'sarada-customize', get_template_directory_uri() . '/inc/js/customize.js', array( 'jquery', 'customize-controls' ), SARADA_LITE_THEME_VERSION, true );
}
