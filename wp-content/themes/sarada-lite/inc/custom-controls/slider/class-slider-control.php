<?php
/**
 * Sarada Lite Customizer Slider Control.
 * 
 * @package Sarada_Lite
*/
...
if ( ! class_exists( 'Sarada_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Sarada_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'sarada-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'sarada-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'sarada-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
