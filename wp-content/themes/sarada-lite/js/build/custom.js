jQuery(document).ready(function($) {
    ...
    $(window).load(function() {
        ...
        $(window).scroll(function() {
          if ($('.site-header.style-one').length == '1' || $('.site-header.style-four').length == '1'){
            var headerOffset = $(".site-header.style-one + div, .site-header.style-four + div").offset().top;
    ...
    //toggle submenu
    $('.nav-menu .menu-item-has-children .submenu-toggle').click(function() {
	...
	$('.sticky-newsletter-wrap .newsletter-toggle').click(function(e) {
		e.stopPropagation();
		$(this).parent('.sticky-newsletter-wrap').toggleClass('active');
	});

	$('.sticky-newsletter-wrap .sticky-newsletter-inner').click(function(e) {
		e.stopPropagation();
	});
    ...
    $('.site-banner.style-four .item-wrap .owl-next').click(function() {
    ...
    $('.site-banner.style-four .item-wrap .owl-prev').click(function() {
    ...
    //move sidebar below trending section
    $(window).on('load resize', function() {
        if($(window).width() < 1025) {
            
            if( sarada_lite_data.ed_newsletter == '1' && sarada_lite_data.newsletter_shortcode ) {
                $('.home .widget-area').insertBefore('.home .newsletter-block');
            }else {
                $('.home .widget-area').insertBefore('.home .site-footer');
            }
    ...
    $('.main-navigation ul li a, .secondary-nav ul li a, .footer-menu ul li a, ul[class*="photos-"] li a').focus(function() {
        $(this).parents('li').addClass('hover');
    }).blur(function() {
        $(this).parents('li').removeClass('hover');
    });

    $("article a").focus(function() {
        $(this).parents('article').addClass('hover');
    }).blur(function() {
        $(this).parents('article').removeClass('hover');
    });

    $(".header-cart a").focus(function() {
