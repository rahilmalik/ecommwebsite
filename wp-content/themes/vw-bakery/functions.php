...
function vw_bakery_activation_notice() {
	...
	echo '<h3>'. esc_html__( 'Warm Greetings to you!!', 'vw-bakery' ) .'</h3>';
...
function vw_bakery_scripts() {
	...
	wp_enqueue_script( 'vw-bakery-custom-scripts-jquery', get_template_directory_uri() . '/assets/js/vw-bakery-custom.js', array('jquery') );
