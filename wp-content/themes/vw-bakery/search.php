    ...
    <div class="middle-align container">
        <?php
            ...
            if($vw_bakery_theme_lay == 'Left Sidebar'){ ?>
                <div class="row m-0">
                    ...
                    <div id="our-services" class="col-lg-8 col-md-8">
                        <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-bakery'), esc_html( get_search_query() ) ); ?></h1> 
                        <?php if ( have_posts() ) :
                            /* Start the Loop */
                        ...
                        ?>
                        <?php if( get_theme_mod( 'vw_bakery_blog_pagination_hide_show',true) != '') { ?>
            ...
            <?php }else if($vw_bakery_theme_lay == 'Grid Layout'){ ?>
                <div class="row m-0">
                    <div id="our-services" class="col-lg-9">
                        <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-bakery'), esc_html( get_search_query() ) ); ?></h1> 
                        <div class="row">
                            <?php if ( have_posts() ) :
                            /* Start the Loop */
