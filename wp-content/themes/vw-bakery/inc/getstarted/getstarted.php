...
function vw_bakery_admin_theme_style() {
   ...
   wp_enqueue_style('vw-bakery-custom-admin-style', get_template_directory_uri() . '/inc/getstarted/getstarted.css');
   wp_enqueue_script('vw-bakery-tabs', get_template_directory_uri() . '/inc/getstarted/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_bakery_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Getting Started', 'vw-bakery' ); ?></button>		  
